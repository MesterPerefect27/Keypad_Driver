...
#define KeyPad_SW_1  '0'
#define KeyPad_SW_2  '1'
#define KeyPad_SW_3  '2'
#define KeyPad_SW_4  '3'
#define KeyPad_SW_5  '4'
#define KeyPad_SW_6  '5'
#define KeyPad_SW_7  '6'
#define KeyPad_SW_8  '7'
#define KeyPad_SW_9  '8'
#define KeyPad_SW_10 '9'
#define KeyPad_SW_11 '+'
#define KeyPad_SW_12 '-'
#define KeyPad_SW_13 '*'
#define KeyPad_SW_14 '%'
#define KeyPad_SW_15 '/'
#define KeyPad_SW_16 'C'
